...
def send_render_ok_email(thumbnail_presigned_url, output_zip_presigned_url, ses_config, render_details, zip_size, runtime_minutes):
    ...
    template_data = {
        ...
        'brender_download_url': "brenderstudio.com/download-render?id=" + output_zip_presigned_url + "&project=" + project_name + "&scene=" + scene_name + "&layer=" + layer_name + "&camera=" + camera_name + "&samples=" + samples + "&engine=" + engine + "&render_type=" + render_type + "&resolution=" + resolution,
